...
(i) become a palindrome in less than fifty iterations, or, (ii) no one, with all the computing power that exists, has managed so far to map it to a palindrome. 
...
for n in [47, 196, 349, 4994]:
    print(is_lychrel(n))

print(sum([1 - is_lychrel(i) for i in range(10000)]))